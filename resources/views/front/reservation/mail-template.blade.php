                ...
                <tr>
                    <td style="font-family:Arial;font-size:14px;padding:25px 30px;line-height:24px">
                        ...
                        <table align="center" cellpadding="0" cellspacing="0" border="0" width="400" style="margin:30px auto;width:400px;padding:0;border:1px solid #b7b7b7;background:white">
                            ...
                            @endif
                            <tr>
                                <td style="font-family:Arial;font-size:14px;padding:0 15px 15px;line-height:18px"><b>Przyjazd</b>:</td>
                                <td style="font-family:Arial;font-size:14px;padding:0 15px 15px;line-height:18px">{{ $request->form_checkin }}</td>
                            </tr>
                            <tr>
                                <td style="font-family:Arial;font-size:14px;padding:0 15px 15px;line-height:18px"><b>Wyjazd</b>:</td>
                                <td style="font-family:Arial;font-size:14px;padding:0 15px 15px;line-height:18px">{{ $request->form_checkout }}</td>
                            </tr>
